...
const { abi: factoryAbi } = require("../dexswap-core/build/DEXswapFactory.json");
const {
    abi: feeSetterAbi,
...
task(
    ...
    .setAction(async (taskArguments, hre) => {
        ...
        console.log();
        console.log(`Native asset wrapper from fee receiver: ${await feeReceiverContract.methods .WETH().call()}`);
        console.log(`Native asset receiver from fee receiver: ${nativeAssetFeeReceiver}`);
        console.log(`Fallback receiver from fee receiver: ${fallbackAssetFeeReceiver}`);
