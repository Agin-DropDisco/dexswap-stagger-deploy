...
} = require("../dexswap-core/build/DEXswapFeeSetter.json");
const {
    abi: feeReceiverAbi,
    bytecode: feeReceiverBytecode,
} = require("../dexswap-core/build/DEXswapFeeReceiver.json");
const {
    abi: routerAbi,
    bytecode: routerBytecode,
} = require("../dexswap-periphery/build/DEXswapRouter.json");
...
task(
    ...
    .setAction(async (taskArguments, hre) => {
        ...
        console.log(`::: Fee setter deployed at address ${feeSetterContract.options.address}`);
        console.log(`---------------------------------------------------------------------------`);

        console.log(`::: Fee receiver deployed at address ${feeReceiverContract.options.address}`);
        console.log(`---------------------------------------------------------------------------`);
        console.log();

        console.log(`::: Periphery`);
        console.log(`Router deployed at address ${routerContract.options.address}`);
        console.log(`---------------------------------------------------------------------------`);

        console.log();
        console.log(`::: Owners `);
        console.log(`Fee setter owned by address ${await feeSetterContract.methods.owner().call()}`);
        console.log(`---------------------------------------------------------------------------`);

        console.log(`::: Fee receiver owned by address ${await feeReceiverContract.methods.owner().call()}`);
        console.log(`---------------------------------------------------------------------------`);
        ...
        console.log(`Fee setter is set to ${await factoryContract.methods.feeToSetter().call()} in factory`);
        console.log(`---------------------------------------------------------------------------`);

        console.log(`Fee receiver is set to ${await factoryContract.methods.feeTo().call()} in factory`);
        console.log(`---------------------------------------------------------------------------`);
